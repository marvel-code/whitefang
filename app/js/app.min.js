...
document.addEventListener('DOMContentLoaded', function () {
  ...
  new swiper__WEBPACK_IMPORTED_MODULE_6__/* .Swiper */ .tq(".section__main .doctor-cols-swiper", {
    slidesPerView: 1,
    effect: 'fade',
    speed: 300,
    fadeEffect: {
  ...
  new swiper__WEBPACK_IMPORTED_MODULE_6__/* .Swiper */ .tq(".doctor-page .doctor-cols-swiper", {
    slidesPerView: 1,
    effect: 'fade',
    speed: 300,
    fadeEffect: {
    ...
    on: {
      slideChange: function slideChange() {
        var bulletsAll = document.querySelectorAll(".doctor-cols-swiper .swiper-pagination-bullet");
        var sliderdoctorSmoll = document.querySelectorAll(".doctor-cols-swiper");
        sliderdoctorSmoll.forEach(function (elem) {
          var index = elem.swiper.realIndex;
  ...
  var sliderRooms = new swiper__WEBPACK_IMPORTED_MODULE_6__/* .Swiper */ .tq(".slider__rooms", {
    ...
    on: {
      slideChange: function slideChange() {
        var bulletsAll = document.querySelectorAll(".slider__rooms .swiper-pagination-bullet");
