...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (humburger !== null) {
    ...
    var overlayClase = document.querySelectorAll(".overlay__clase");
    ...
    overlay.forEach(function (close) {
    ...
    overlayClase.forEach(function (close) {
      close.addEventListener("click", function () {
        overlay.forEach(function (i) {
          i.classList.add("animate__fadeOutRight");
          i.classList.remove("animate__fadeInRight");
  ...
  var aboutUs = new swiper__WEBPACK_IMPORTED_MODULE_6__/* .Swiper */ .tq(".aboutUs", {
    direction: "vertical",
    speed: 3000,
    pagination: {
      el: ".swiper-pagination",
  ...
  function menuCheck(el) {
    ...
    var topMenuWhite = document.querySelector(".topMenu__white");
    var topMenuBlack = document.querySelector(".topMenu__black");
    slideClass.classList.forEach(function (item) {
      console.log(item);
...
jquery__WEBPACK_IMPORTED_MODULE_1__(window).on('load', function () {
  ...
  var centerSlideIndex = 1;
  var rightSlideIndex = 2; // Slide loop
